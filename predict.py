...
class CirclePredictor:
    ...
    def predict_single_image(self, image_path, return_heatmap=False):
        """预测单张图像的圆心"""
        # 预处理
    ...
    def visualize_prediction(self, image_path, save_path=None, show=True):
        """可视化预测结果"""
        # 获取预测结果
        result = self.predict_single_image(image_path, return_heatmap=True)
...
def main():
    ...
    # 创建预测器
    predictor = CirclePredictor(args.model, args.device)
